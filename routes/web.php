...
Route::middleware(['auth', 'role:inspector'])->group(function () {
    ...
    Route::put('/inspections/{id}', [InspectorController::class, 'updateInspection'])->name('inspections.update');
...
Route::middleware('auth')->group(function () {
    Route::post('/risk/run/{id}', [AnalystController::class, 'runRisk'])->name('risk.run');
